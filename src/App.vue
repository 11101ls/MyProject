...
<template>
 <el-scrollbar class="list" ref="bodyBox" >
  
 
  <TabBar class="animated fadeIn animate__slower"  @scrollTop=" scrollTop "></TabBar>
  <router-view v-slot="{ Component }">
    <transition 
      enter-active-class="animated fadeIn animate__slower" >
